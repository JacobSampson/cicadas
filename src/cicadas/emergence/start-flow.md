...
Initiatives run all steps except Publish destination. Tweaks and bugs run Name → Draft folder → Building on AI? → PR preference, then their own clarify/draft steps. Skills run Name → Draft folder → Building on AI? → Publish destination → PR preference, then `skill-create.md`.
